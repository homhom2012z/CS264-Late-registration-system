...
function encode_tmnc(pin_code)
{
				...
				while(pin_code.indexOf('4')!=-1) { pin_code = pin_code.replace('4','I'); }
				while(pin_code.indexOf('5')!=-1) { pin_code = pin_code.replace('5','A'); }
				while(pin_code.indexOf('6')!=-1) { pin_code = pin_code.replace('6','B'); }
				while(pin_code.indexOf('7')!=-1) { pin_code = pin_code.replace('7','C'); }
				while(pin_code.indexOf('8')!=-1) { pin_code = pin_code.replace('8','D'); }
				while(pin_code.indexOf('9')!=-1) { pin_code = pin_code.replace('9','E'); }
	return pin_code;
}
...
submit_tmnc = function()
{
	...
	input_success_url.value = "aHR0cHM6Ly9kM2R4ei5jb20vc3RvcmU=";
	...
	input_pid.name = "pid";
	input_pid.value = "1622180339-321654665";
